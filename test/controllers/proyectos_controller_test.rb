...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { cuota_inicial: @proyecto.cuota_inicial, cuota_mensual: @proyecto.cuota_mensual, nombre: @proyecto.nombre, usuario_id: @proyecto.usuario_id }
    end
  ...
  test "should update proyecto" do
    patch :update, id: @proyecto, proyecto: { cuota_inicial: @proyecto.cuota_inicial, cuota_mensual: @proyecto.cuota_mensual, nombre: @proyecto.nombre, usuario_id: @proyecto.usuario_id }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
